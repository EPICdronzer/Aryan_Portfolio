...
export default function Navbar() {
  ...
  return (
    <>
      <nav ref={navRef} className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-20 lg:px-32 flex items-center justify-between">
          ...
          <Link href="/" className="nav-logo flex items-center gap-2 group relative z-50">
            ...
            {/* Mobile + Tablet: show favicon.png logo */}
          ...
          <button
            ...
            className="lg:hidden flex flex-col justify-center items-center w-8 h-8 space-y-1.5 focus:outline-none z-50 relative"
      ...
      <div className={`fixed inset-0 bg-[#070709]/98 backdrop-blur-2xl z-40 transition-all duration-500 lg:hidden flex flex-col justify-between p-8 pt-28 pb-12 ${
